...
//  Kalkulator
//
//  Created by Edi Sunardi on 10/11/20.
//
...
class ViewController: UIViewController {
    ...
    @IBOutlet weak var lebelHasil: UILabel!
    ...
    func hitung(aritmetik : String){
        if textField1.text == "" || textField2.text == ""{ lebelHasil.text = "tidak boleh kosong"
        } else {
